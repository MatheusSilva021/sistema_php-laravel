...
@section('head')
    <style>
        ...
        .minus {
            ...
            background-repeat: no-repeat;
            display: inline-block;
            background-image: url('data:image/png;base64,');
        }
        ...
        .plus {
            ...
            background-repeat: no-repeat;
            display: inline-block;
            background-image: url('data:image/png;base64,');
        }
...
@section('conteudo')
    <nav class="navbar fixed-top bg-body-tertiary">
        <div class="container-fluid">
            <h1 class="navbar-brand fs-3">Itens</h1>
            <ul class="navbar-nav me-2 mb-2 mb-lg-0">
                <li class="nav-item">
                    <a href="/comanda/{{ $comanda }}" class="fs-5 btn-voltar"><i class="icon"></i>Voltar</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <nav class="navbar fixed-bottom bg-body-tertiary">
        <div class="container-fluid">
            <input type="submit" class="btn btn-add btn-success w-100" value="Enviar">
        </div>
    </nav>
    ...
    <script type="text/javascript">
        function change(cod) {
            const myInput = document.getElementById(cod);
            let value = myInput.getAttribute("value");

            const observacaoElement = document.getElementById('observacao' + cod);
            const lobservacaoElement = document.getElementById('lobservacao' + cod);

            if (value > 0) {
                observacaoElement.style.display = 'block';
                lobservacaoElement.style.display = 'block';
            } else {
                observacaoElement.style.display = 'none';
                lobservacaoElement.style.display = 'none';
            }
        }

        function stepper(btn, cod) {
            const myInput = document.getElementById(cod);
    ...
    <button><a href="/comanda/{{ $comanda }}">Voltar</a></button>
@endsection
